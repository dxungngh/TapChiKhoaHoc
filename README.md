...
- Rename the base package `com.danielnguyen.boilerplate` to your preferred name. *[How to]*
...
```
import com.danielnguyen.boilerplate.domain.executor.Executor;
import com.danielnguyen.boilerplate.domain.executor.MainThread;
import com.danielnguyen.boilerplate.domain.interactors.WelcomingInteractor;
import com.danielnguyen.boilerplate.domain.interactors.base.AbstractInteractor;
import com.danielnguyen.boilerplate.domain.repository.MessageRepository;
```
